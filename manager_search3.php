...
<head>
       ...
       <title>MANAGER_SEARCH3 PAGE</title>
</head>
<body >
 <?php
...
<?php
     ...
     if (!$conn){
      ...
      echo "<p>Database connection failure</p>";}
            ...
            $sql_table = "orders";
            $query = "Select order_id,first_name,last_name,party_equipment,candles_qty,speakers_qty,confetti_qty,lights_qty,balloons_qty,order_cost,order_time,order_status FROM orders where order_status = 'PENDING'";
