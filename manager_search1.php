...
<head>
       ...
       <title>MANAGER_SEARCH1 PAGE</title>
</head>
<body >
 <?php
...
<?php
     ...
     if (!$conn){
      ...
      else{   $firstname = trim($_POST["name"]);
              $firstname = htmlspecialchars($firstname);
              $firstname = mysqli_escape_string($conn,$firstname);
            
            $sql_table = "orders";
            $query = "Select order_id,first_name,last_name,party_equipment,candles_qty,speakers_qty,confetti_qty,lights_qty,balloons_qty,order_cost,order_time,order_status FROM orders where first_name = '$firstname'";
